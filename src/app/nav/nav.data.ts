    ...
    children: [
      {
        ...
        label: 'Введение',
        children: [
          { id: 'why', label: 'Зачем этот раздел' },
          { id: 'anatomy', label: 'Анатомия веб-приложения' },
          { id: 'how-to-choose', label: 'Как выбирать технологию' },
      ...
      },
      {
        ...
        label: 'Клиент',
        children: [
          { id: 'browser', label: 'Что делает браузер' },
          { id: 'why-frameworks', label: 'Почему не пишут на ванильном JS' },
          { id: 'frameworks', label: 'React, Vue, Angular, Svelte' },
          { id: 'meta-frameworks', label: 'Мета-фреймворки и рендеринг' },
          { id: 'bundlers', label: 'Сборщики' },
          { id: 'package-managers', label: 'Пакетные менеджеры и монорепы' },
          { id: 'styling', label: 'Стили и UI-киты' },
          { id: 'state', label: 'Управление состоянием' },
          { id: 'data-fetching', label: 'Работа с данными' },
          { id: 'testing', label: 'Тестирование фронтенда' },
          { id: 'mobile-desktop', label: 'Мобильные и десктопные приложения' },
          { id: 'quality', label: 'Доступность, i18n, Core Web Vitals' },
        ],
      },
      {
        id: 'backend',
        label: 'Бэкенд',
        children: [
          { id: 'what-backend-does', label: 'Что делает бэкенд' },
          { id: 'node', label: 'Node.js, Deno, Bun' },
          { id: 'python', label: 'Python' },
          { id: 'go', label: 'Go' },
          { id: 'jvm-dotnet', label: 'Java, Kotlin, C#/.NET' },
          { id: 'php-ruby', label: 'PHP и Ruby' },
          { id: 'rust-cpp', label: 'Rust и C++' },
          { id: 'how-to-choose', label: 'Как выбрать язык' },
        ],
      },
      {
        id: 'api',
        label: 'Связь между частями',
        children: [
          { id: 'http', label: 'HTTP на пальцах' },
          { id: 'rest', label: 'REST' },
          { id: 'graphql', label: 'GraphQL' },
          { id: 'grpc', label: 'gRPC и Protobuf' },
          { id: 'realtime', label: 'Реалтайм: WebSocket, SSE, WebRTC' },
          { id: 'queues', label: 'Очереди и брокеры' },
          { id: 'webhooks', label: 'Вебхуки и интеграции' },
          { id: 'contracts', label: 'Контракты API: OpenAPI, версии, лимиты' },
        ],
      },
      {
        id: 'data',
        label: 'Данные и хранилища',
        children: [
          { id: 'relational', label: 'PostgreSQL и MySQL' },
          { id: 'nosql', label: 'MongoDB и документные БД' },
          { id: 'redis', label: 'Redis и кэш' },
          { id: 'search', label: 'Поисковые движки' },
          { id: 'analytics', label: 'Аналитические БД' },
          { id: 'timeseries', label: 'Временные ряды' },
          { id: 'vector', label: 'Векторные БД и эмбеддинги' },
          { id: 'object-storage', label: 'Файлы и объектное хранилище' },
          { id: 'orm', label: 'ORM и миграции' },
          { id: 'fundamentals', label: 'Индексы, транзакции, репликация, бэкапы' },
          { id: 'how-to-choose', label: 'Какую БД выбрать' },
        ],
      },
      {
        id: 'infra',
        ...
        children: [
          { id: 'deploy-basics', label: 'Путь от кода до продакшена' },
          { id: 'docker', label: 'Docker и контейнеры' },
          { id: 'kubernetes', label: 'Kubernetes' },
          { id: 'serverless', label: 'Serverless и edge-функции' },
          { id: 'hosting', label: 'Облака, VPS и PaaS' },
          { id: 'nginx', label: 'Nginx, Caddy, Traefik' },
          { id: 'cdn', label: 'CDN и Cloudflare' },
          { id: 'dns-tls', label: 'DNS, домены, сертификаты' },
          { id: 'cicd', label: 'CI/CD' },
          { id: 'iac', label: 'Infrastructure as Code' },
          { id: 'environments', label: 'Окружения, конфиги и секреты' },
        ],
      },
      {
        id: 'security',
        label: 'Безопасность',
        children: [
          { id: 'authn-authz', label: 'Аутентификация и авторизация' },
          { id: 'sessions-jwt', label: 'Сессии, JWT, OAuth, SSO' },
          { id: 'auth-services', label: 'Готовые сервисы авторизации' },
          { id: 'owasp', label: 'OWASP Top 10 на пальцах' },
          { id: 'browser-security', label: 'CORS, CSP, HTTPS, HSTS' },
          { id: 'secrets', label: 'Пароли, MFA, секреты' },
          { id: 'privacy', label: 'Персональные данные' },
          { id: 'abuse', label: 'Боты, rate limiting, WAF' },
        ],
      },
      {
        id: 'observability',
        ...
        children: [
          { id: 'logs', label: 'Логи' },
          { id: 'metrics', label: 'Метрики: Prometheus и Grafana' },
          { id: 'tracing', label: 'Трейсинг и OpenTelemetry' },
          { id: 'errors', label: 'Отслеживание ошибок: Sentry' },
          { id: 'uptime', label: 'Аптайм и алерты' },
          { id: 'product-analytics', label: 'Продуктовая аналитика' },
          { id: 'slo', label: 'SLA, SLO и дежурства' },
        ],
      },
      {
        id: 'process',
        label: 'Процесс и качество',
        children: [
          { id: 'git', label: 'Git, ветвление, code review' },
          { id: 'linters', label: 'Линтеры и форматтеры' },
          { id: 'tests', label: 'Пирамида тестов' },
          { id: 'static-analysis', label: 'Типы и статический анализ' },
          { id: 'docs', label: 'Документация: OpenAPI, Storybook, ADR' },
          { id: 'trackers', label: 'Трекеры задач' },
        ],
      },
      {
        id: 'architecture',
        label: 'Архитектура',
        children: [
          { id: 'monolith-microservices', label: 'Монолит, микросервисы, модульный монолит' },
          { id: 'request-path', label: 'Путь запроса и слои системы' },
          { id: 'caching', label: 'Кэширование на всех уровнях' },
          { id: 'background-jobs', label: 'Фоновые задачи и воркеры' },
          { id: 'scaling', label: 'Масштабирование' },
          { id: 'resilience', label: 'Отказоустойчивость' },
          { id: 'multitenancy', label: 'Мультитенантность' },
        ],
      },
      {
        id: 'services',
        label: 'Сервисы вокруг продукта',
        children: [
          { id: 'payments', label: 'Платежи и подписки' },
          { id: 'notifications', label: 'Почта, push, SMS' },
          { id: 'media', label: 'Файлы, изображения, видео' },
          { id: 'maps', label: 'Карты и геолокация' },
          { id: 'cms', label: 'CMS: headless и классические' },
          { id: 'experiments', label: 'A/B-тесты и feature-флаги' },
          { id: 'seo', label: 'SEO и метатеги' },
        ],
      },
      {
        id: 'ai',
        label: 'AI в продукте и в разработке',
        children: [
          { id: 'llm-api', label: 'LLM API: токены, цена, лимиты' },
          { id: 'rag', label: 'Эмбеддинги и RAG' },
          { id: 'agents', label: 'Агенты, tool use, MCP' },
          { id: 'what-to-delegate', label: 'Что отдавать нейросети, а что нет' },
          { id: 'prompting-stack', label: 'Как ставить задачу, зная стек' },
        ],
      },
      {
        id: 'recipes',
        label: 'Рецепты «хочу сделать X»',
        children: [
          { id: 'landing', label: 'Лендинг и сайт-визитка' },
          { id: 'blog', label: 'Блог и медиа' },
          { id: 'ecommerce', label: 'Интернет-магазин' },
          { id: 'saas', label: 'SaaS с подписками' },
          { id: 'marketplace', label: 'Маркетплейс' },
          { id: 'chat', label: 'Реалтайм-чат' },
          { id: 'mobile-app', label: 'Мобильное приложение с бэком' },
          { id: 'admin-tool', label: 'Внутренний админ-инструмент' },
          { id: 'ai-service', label: 'AI-сервис поверх LLM' },
        ],
      },
    ],
  },
